...
class OpenAIService {
  ...
  async generateImage(base64Image, style, description) {
    ...
    const prompt = `You are a professional artist. Using this sketch as inspiration and the description: "${description}", create an original artistic interpretation in the style of ${style}. 
